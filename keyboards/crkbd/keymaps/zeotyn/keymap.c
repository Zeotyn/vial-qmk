...
// Define layers
enum layers { _COLEMAK, _QWERTY, _LOWER, _RAISE, _ADJUST };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, TL_LOWR, KC_ESC, KC_SPC, TL_UPPR, KC_RALT
        ),
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_LBRC, KC_RBRC, KC_LT, KC_GT, KC_BSLS, KC_GRV,
